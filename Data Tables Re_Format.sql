use hch_july_compare;


CREATE TABLE mbs_0719_adj
...
FROM diab_0719 A
LEFT JOIN mbs_0719_adj D
ON A.measure = D.measure
INNER JOIN mbs_mh_0719 G
ON A.measure = G.measure
INNER JOIN pdq_0719 J
...
from diab_0720 B
left join mbs_0720_adj E
on B.measure = E.measure
inner join mbs_mh_0720 H
on B.measure = H.measure
inner join pdq_0720 K
...
FROM diab_0721 C
LEFT JOIN mbs_0721_adj F
ON C.measure = F.measure
INNER JOIN mbs_mh_0721 I
ON C.measure = I.measure
INNER JOIN pdq_0721 L
...
ALTER TABLE  all_hch_perc MODIFY perc_popcd varchar(20) AFTER totalcd;
ALTER TABLE  all_hch_perc MODIFY perc_gpmp varchar(20) AFTER cdm_gpmp;
ALTER TABLE  all_hch_perc MODIFY perc_tca varchar(20) AFTER cdm_tca;
ALTER TABLE  all_hch_perc MODIFY perc_review varchar(20) AFTER cdm_review;
ALTER TABLE  all_hch_perc MODIFY perc_mh varchar(20) AFTER mhnumber;
ALTER TABLE  all_hch_perc MODIFY perc_mhtp varchar(20) AFTER gp_mhtp;
ALTER TABLE  all_hch_perc MODIFY perc_mhtp_review varchar(20) AFTER gp_mhtp_review;
ALTER TABLE  all_hch_perc MODIFY perc_indigenous varchar(20) AFTER indigenous;
ALTER TABLE  all_hch_perc MODIFY perc_ha715 varchar(20) AFTER ha715;
ALTER TABLE  all_hch_perc MODIFY perc_45_49 varchar(20) AFTER 45to49;
ALTER TABLE  all_hch_perc MODIFY perc_ha45_49 varchar(20) AFTER ha45to49;
ALTER TABLE  all_hch_perc MODIFY perc_75plus varchar(20) AFTER 75plus;
ALTER TABLE  all_hch_perc MODIFY perc_ha75plus varchar(20) AFTER ha75Plus;
